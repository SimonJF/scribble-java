 ...
 * 
 */
public class LCallRespReceive extends LActivity {
     ...
     */
    public LCallRespReceive(LCallRespReceive i) {
        super(i);
     ...
     */
    public LCallRespReceive(Message sig, Role fromRole) {
        _message = sig;
        _fromRole = fromRole;
    }
    ...
    public String toString() {
        ...
        ret.append("receive_call_response ");
    ...
    public void toText(StringBuffer buf, int level) {
    	...
    	indent(buf, level);
        buf.append("receive_call_response ");	
